        ...
        <div class="pictures w-full overflow-clip flex flex-col md:flex-row gap-2">
            ...
            <figure class="w-full h-full relative rounded md:w-2/3">
                ...
                @if(isset($mainBanner->image_url))
                    <img src="{{ $mainBanner->image_url}}" class="rounded lazyloaded md:h-[580px] object-cover w-full"
            ...
            <div class="w-full flex-col hidden sm:flex gap-2 md:w-1/3">
                ...
                <figure class="rounded relative h-1/2 overflow-clip">
                    ...
                    @if(isset($trBanner->image_url))
                        <img src="{{ $trBanner->image_url}}" class="rounded lazyloaded" alt="" decoding="async"
                             sizes="(max-width: 680px) 100vw, 680px" srcset="{{ $trBanner->image_url }}"
                             data-ll-status="loaded">
                    @else

                        <img src="{{ asset('images/right_banner-1.jpg') }}" class="rounded" alt="" decoding="async"
                             sizes="(max-width: 400px) 100vw, 400px" srcset="{{ asset('images/right_banner-1.jpg') }}"/>
                ...
                <figure class="rounded relative h-1/2 overflow-clip">
                    ...
                    @if(isset($brBanner->image_url))
                        <img src="{{ $brBanner->image_url}}" class="rounded lazyloaded" alt="" decoding="async"
                             sizes="(max-width: 680px) 100vw, 680px" srcset="{{ $brBanner->image_url }}"
                             data-ll-status="loaded">
                    @else

                        <img src="{{ asset('images/right_banner-2.jpg') }}" class="rounded" alt="" decoding="async"
                             sizes="(max-width: 400px) 100vw, 400px" srcset="{{ asset('images/right_banner-2.jpg') }}"/>
